...
9) [Сервисы](#сервисы)
9.1) [Интерфейс AlbumService](#интерфейс-albumservice)
9.2) [Интерфейс AuditLogService](#интерфейс-AuditLogService)
9.3) [Интерфейс PostService](#интерфейс-PostService)
