...
# Аннотации и классы для JSON сериализации
...
В рамках приложения используются аннотации и классы для сериализации объектов в формат JSON. Ниже приведены классы и аннотации, используемые для этой цели.
